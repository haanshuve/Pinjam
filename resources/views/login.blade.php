...
<body class="bg-white">
    <div
        ...
        <div class="font-poppins w-fit text-primary2 m-auto md:m-0 p-5 md:py-10 md:pr-10">
            ...
            <form class="flex flex-col md:w-80 gap-3 mt-8 tracking-wide ">
                <div class="flex flex-col gap-1">
                    <p class="font-semibold relative">NIP</p>
                    <input type="text" placeholder="NIK"
                        class="border-2 shadow-sm px-2 py-1 w-full rounded-md text-sm bg-slate-100">
                </div>
                <div class="flex flex-col gap-1">
                    <p class="font-semibold">Kata Sandi</p>
                    <input type="password" placeholder="Kata Sandi"
                        class="border-2 border-slate-200 px-2 py-1 w-full rounded-md shadow-sm text-sm bg-slate-100">
                </div>

                <a href="#" class="text-blue-700 text-sm font-semibold text-right mt-1">Lupa kata sandi?</a>

                <a href="dashboard" class="bg-primary2 mt-4 rounded-md font-bold p-2 text-center text-white hover:opacity-80">Masuk</a>

                <p class="text-slate-700 text-center text-sm mt-3">Ada kendala dalam proses login? hubungi kami
                    <b>@politekniknegeribatam</b>
                </p>
            </form>
        </div>
